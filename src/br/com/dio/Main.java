...
import br.com.dio.utils.BoardTemplate;
...
public class Main {
    ...
    private static void clearGame() {
        ...
        System.out.println("Tem certeza que deseja limpar o jogo e apagar todo seu progresso?");
        var confirm = sc.next();
    ...
    private static void finishGame() {
        ...
        if(board.gameIsFinished()){
            ...
            System.out.println("O jogo tem erros, verifique o seu board e ajuste-o.");
